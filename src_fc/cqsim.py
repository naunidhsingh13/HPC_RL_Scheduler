...
if __name__ == "__main__":
    ...
    p.add_option("--weight_num", dest="weight_num", type="int", \
                 #default="Debug/", \
                 help="the file num read weights from")
    ...
    #45
    p.add_option("--weight_name", dest="weight_name", type="string", \
                 help="file name to read weights from")

    p.add_option("--weights_fp", dest="weights_fp", type="string",
                 help="path to weights for actor (not used if is_training is 1)")
    ...
    inputPara['weight_num']=opts.weight_num
    inputPara['weight_name']=opts.weight_name
    inputPara['is_training']=opts.is_training
    inputPara['weights_fp'] = opts.weights_fp
