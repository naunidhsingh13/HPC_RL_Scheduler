...
if __name__ == "__main__":
    ...
    p.add_option("--input_weight_fp", dest="input_weight_file", type="string",
                 default="",
                 help="file name to read weights from")

    # 46
    p.add_option("--output_weight_fp", dest="output_weight_file", type="string",
                 default="",
    ...
    if inputPara['output_weight_file']:
        inputPara['output_weight_file'] = inputPara['path_fmt'] + inputPara['output_weight_file']
